...
import thesis_experiments.experiment2.LSTM_manager_6D as LSTM_manager_6D
...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('6D_20-step ahead predict_exp2', params = PARAMS, upload_source_files=['./thesis_experiments/experiment2/LSTM_manager_2D.py', './thesis_experiments/experiment2/2D_predictor.py'], tags=['single_run', '6D-prediction', '4-year', '20-step-ahead', '20-predictions', 'shifted30', 'seed'+str(seed)])
