...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('3D_predictor_exp4_presence', params = PARAMS, upload_source_files=['./thesis_experiments/experiment4/LSTM_manager_3D.py', './thesis_experiments/experiment4/3D_predictor_presence.py'], tags=['single_run', '3D-prediction', '4-year', '20-step-ahead', '20-predictions', 'shifted30', 'presence','seed'+str(seed)])
    ...
    data = df.filter(items=[data_name, lagged_data_name, presence])
