...
import thesis_experiments.experiment3.LSTM_manager_6D as LSTM_manager_6D
...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('6D_20-step ahead predict_exp3', params = PARAMS, upload_source_files=['./thesis_experiments/experiment3/LSTM_manager_6D.py', './thesis_experiments/experiment3/6D_predictor.py'], tags=['single_run', 'no-extra-feature', '6D-prediction', '4-year', '20-step-ahead', '20-predictions', 'quarterly','seed'+str(seed)])
