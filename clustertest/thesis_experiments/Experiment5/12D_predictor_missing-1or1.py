...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('12D_20-step ahead predict_exp5_presence', params = PARAMS, upload_source_files=['./thesis_experiments/experiment5/LSTM_manager_12D.py', './thesis_experiments/experiment5/12D_predictor_missing-1or1.py'], tags=['single_run', 'presence', '12D-prediction', '4-year', '20-step-ahead', '20-predictions', 'quarterly','seed'+str(seed)])
    ...
    data = df.filter(items=[data_name, EnterpriseValue_meanlast260, EnterpriseValue_linearfit260, PeRatio_meanlast260,
     PeRatio_linearfit260, ForwardPeRatio_meanlast260, ForwardPeRatio_linearfit260, PegRatio_meanlast260, PegRatio_linearfit260, EnterprisesValueEBITDARatio_meanlast260, EnterprisesValueEBITDARatio_linearfit260, presence])
    ...
    # "PEG_meanlast260","PEG_linearfit260","EV_EBITDA_meanlast260","EV_EBITDA_linearfit260","presence", "y_test", "y_pred"]
    # )
    fig3, ax = plot_series(
    y_train,
    y_train_EV_linearfit260,
