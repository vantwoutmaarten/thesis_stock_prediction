...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('7D_20-step ahead predict_exp5_time-lag', params = PARAMS, upload_source_files=['./thesis_experiments/experiment5/LSTM_manager_7D.py', './thesis_experiments/experiment5/7D_predictor_time_lag.py'], tags=['single_run', 'time-lag', '7D-prediction', '4-year', '20-step-ahead', '20-predictions', 'quarterly','seed'+str(seed)])
