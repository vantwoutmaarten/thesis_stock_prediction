...
import thesis_experiments.Baseline.LSTM_manager_1D as LSTM_manager_1D
...
neptune.init(project_qualified_name='mavantwout/Baseline',
...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('1D_20-step ahead predict_baseline', params = PARAMS, upload_source_files=['./thesis_experiments/Baseline/LSTM_manager_1D.py', './thesis_experiments/Baseline/1D_predictor.py'], tags=['single_run', 'no-extra-feature', '1D-prediction', '4-year', '20-step-ahead', '20-predictions', 'price','seed'+str(seed)])
