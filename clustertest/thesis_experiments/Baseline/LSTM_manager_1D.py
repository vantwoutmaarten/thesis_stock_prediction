...
class LSTMHandler():	
    ...
    def create_train_test_data(self, data = None,
     ...
     test_size=365
        ...
        self.train_data_normalized = torch.cuda.FloatTensor(train_data_normalized).view(-1,1)
    ...
    def make_predictions_from_model(self, modelpath=None, modelstate=None):	
        ...
        actual_predictions = self.scaler.inverse_transform(np.array(test_inputs[-self.test_data_size:]).reshape(-1, 1))
