...
# # Create experiment
# neptune.create_experiment('1-step ahead prediction_seed1_1ep_test', params = PARAMS, upload_source_files=['../timeseries_pytorch_simpleLSTM/LSTM_manager1vs20.py', '../timeseries_pytorch_simpleLSTM/LSTM_manager.py', '1aheadVS20ahead.py'], tags=['single_run', '1D-prediction', '7-year', '1-step-ahead'])
