...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('2D_20-step ahead predict_exp2_test', params = PARAMS, upload_source_files=['./LSTM_manager_2D.py', './2D_predictor.py'], tags=['single_run', '2D-prediction', '4-year', '20-step-ahead', '20-predictions', 'shifted30', 'seed'+str(seed)])
