...
import LSTM_manager_5D_imputed
...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('5D_20-step ahead predict_exp1_test', params = PARAMS, upload_source_files=['../LSTM_manager_5D_imputed.py', '5D_predictor_imputed.py'], tags=['single_run', 'no-extra-feature', '5D-prediction', '4-year', '20-step-ahead', '20-predictions', 'price_imputed','seed'+str(seed)])
