...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('7D_predictor_exp4_test_time_lag', params = PARAMS, upload_source_files=['./LSTM_manager_7D.py', './7D_predictor_time_lag.py'], tags=['single_run', '7D-prediction', '4-year', '20-step-ahead', '20-predictions', 'shifted30','time-lag','seed'+str(seed)])
