...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('3D_predictor_exp4_time-lag', params = PARAMS, upload_source_files=['./LSTM_manager_3D.py', './3D_predictor_time_lag.py'], tags=['single_run', '3D-prediction', '4-year', '20-step-ahead', '20-predictions', 'shifted30', 'time-lag','seed'+str(seed)])
