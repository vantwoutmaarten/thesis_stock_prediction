...
class LSTM(nn.Module):	
    def __init__(self, input_size=12, hidden_layer_size=40, output_size=1, dropout = 0.0, num_layers=1):	
        super().__init__()
    ...
    def forward(self, input_seq):	
        ...
        input_seq = input_seq.view(len(input_seq), 1, 12)
...
class LSTMHandler():	
    ...
    def create_train_test_data(self, data = None,
     ...
     test_size=365
        ...
        self.train_data_normalized = torch.cuda.FloatTensor(train_data_normalized).view(-1,12)
