...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('7D_20-step ahead predict_exp5_test-cluster-presence', params = PARAMS, upload_source_files=['../LSTM_manager_7D.py', '7D_predictor_missing-1or1.py'], tags=['single_run', 'presence', '7D-prediction', '4-year', '20-step-ahead', '20-predictions', 'quarterly','seed'+str(seed)])
