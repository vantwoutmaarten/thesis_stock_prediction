...
for seed in range(seeds):
    # Create experiment
    neptune.create_experiment('12D_20-step ahead predict_exp5_test-local', params = PARAMS, upload_source_files=['../LSTM_manager_12D.py', '12D_predictor_missing-1or1.py'], tags=['single_run', 'presence', '12D-prediction', '4-year', '20-step-ahead', '20-predictions', 'quarterly','seed'+str(seed)])
